...
export const registerContext: registerContext = (context) => exports.er_lib.registerContext(context);

export const showContext = (id: string): void => exports.er_lib.showContext(id);

export const hideContext = (onExit: boolean): void => exports.er_lib.hideContext(onExit);

export const getOpenContextMenu = (): string | null => exports.er_lib.getOpenContextMenu();

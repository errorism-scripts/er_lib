...
AddEventHandler('onResourceStop', function(resourceName)
  ...
  for callbackName, resource in pairs(registeredCallbacks) do
    if resource == resourceName then registeredCallbacks[callbackName] = nil end
  end
end)
...
RegisterNetEvent('er_lib:validateCallback', function(callbackName, invokingResource, key)
  ...
  if cache.game == 'fxserver' then return TriggerClientEvent(event, source, key, 'cb_invalid') end
